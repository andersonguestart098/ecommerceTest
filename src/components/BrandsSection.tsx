...
const BrandsSection = () => {
    return (
        <Box sx={{ py: 5 }}>
            <Typography variant="h4" align="center" gutterBottom sx={{color: '#313926'}}>
                As Melhores Marcas
            </Typography>
                        ...
                        >
                            <Avatar
                                ...
                                sx={{
                                    ...
                                    height: 125,
                                    mb: 2,
                                    border: '2px solid #FAF8F1', // Borda leve
                            ...
                            />
                            <Typography variant="body1" align="center" sx={{ fontSize: 18, color: '#313926' }}>
                                {brand.name}
                            </Typography>
                        </Box>
                    </Grid>
