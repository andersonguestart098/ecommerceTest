...
const Checkout: React.FC = () => {
  ...
  useEffect(() => {
    // Recupera dados do checkout no localStorage
    const checkoutData = JSON.parse(
      localStorage.getItem("checkoutData") || "{}"
    );
    const { amount, items, userId } = checkoutData;
    ...
    const initializeMercadoPago = async () => {
      ...
      const cardForm = mp.cardForm({
        amount: String(amount > 1 ? amount : 1),
        iframe: true,
        form: {
          id: "form-checkout",
          cardNumber: {
        ...
        callbacks: {
          ...
          onSubmit: async (event: any) => {
            ...
            const paymentData = {
              ...
              items, // Inclui os itens diretamente
              userId, // Inclui o userId do localStorage
            };
            ...
            try {
              ...
              console.log(
                "Resposta do servidor após pagamento:",
                response.data
              );
